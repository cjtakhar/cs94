...
{
    /// <summary>
    /// Provides access to the Message resource
    /// </summary>
    ...
    public class PublicMessagesController : ControllerBase
    {
        ...
        /// <summary>
        /// The get message by identifier route name
        /// </summary>
        private const string GetPublicMessageByIdRouteName = nameof(GetPublicMessageByIdRouteName);
        ...
        /// The logger
        /// </summary>
        private ILogger<PublicMessagesController> _logger;
        ...
        public PublicMessagesController(IConfiguration configuration,
                                        ILogger<PublicMessagesController> logger)
        {
        ...
        /// <summary>
        /// The name of the container where public text will be stored in Azure Blob Storage
        /// </summary>
        private const string PUBLIC_MESSAGES_CONTAINER = "publicmessagecontainer";


        /// <summary>
        /// Gets a list of all the messages
        /// </summary>
        /// <returns>A collection of all the messages by name</returns>
        [HttpGet]
        public async Task<IActionResult> Get()
        {

            BlobContainerClient blobContainerClient = new BlobContainerClient(StorageConnectionString, PUBLIC_MESSAGES_CONTAINER);
        ...
        /// <summary>
        /// Gets the specified public message by name from the secret container.
        /// </summary>
        /// <param name="id">Name of the secret message.</param>
        /// <returns>The contents of the secret message</returns>
        [HttpGet("{id}", Name = GetPublicMessageByIdRouteName)]
        public Task<IActionResult> GetById(string id)
        {
            return RetrievePublicMessage(containerName: PUBLIC_MESSAGES_CONTAINER, Id: id);
        }
        ...
        /// <param name="inputPayload">The message.</param>
        ...
        public async Task<IActionResult> PutByNameAndMessage(string messageName, [FromBody] InputPayload inputPayload)
        {
            try
            {
                ...
                string serializedInput = System.Text.Json.JsonSerializer.Serialize(inputPayload);

                // Create a MemoryStream that contains the serializedInput
                using MemoryStream serializedInputStream = new MemoryStream(Encoding.UTF8.GetBytes(serializedInput));

                // Create or overwrite the blob with contents of the message provided
                await blobClient.UploadAsync(serializedInputStream, new BlobHttpHeaders() { ContentType = System.Net.Mime.MediaTypeNames.Application.Json });
                ...
                return CreatedAtRoute(GetPublicMessageByIdRouteName,
        ...
        /// <remarks>The Id of the message is assigned by the server</remarks>
        [HttpPost]
        ...
        public async Task<IActionResult> PostByMessage([FromBody] InputPayload inputPayload)
        {
            ...
            try
            {
                ...
                // Upload the stream instead of the plain message
                await blobClient.UploadAsync(serializedInputStream, new BlobHttpHeaders() { ContentType = System.Net.Mime.MediaTypeNames.Application.Json });
        ...
        /// </remarks>
        private async Task<IActionResult> RetrievePublicMessage(string containerName, string Id)
        {
            try
            {
